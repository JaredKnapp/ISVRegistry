...
<div class="validations form">
    ...
    <fieldset>
        ...
        echo '<br><br>';
        echo $this->Form->input('isMinorUpdate', array('label'=>'Minor update - do not send updates', 'type'=>'checkbox'));

        ?>
    </fieldset>
    <?php

    if(((AuthComponent::user('role')==='editor' && AuthComponent::user('organizations_id')===$this->request->data['PlatformVersion']['Platform']['organizations_id']) || AuthComponent::user('role')==='admin')){
