 ...
 */
Configure::write('Security.salt', ':LKJ89w9 @#$je$jf@#987pjh @#$as9fa sdfas%$#97 08yasdh');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '89106753273947273089827123');
...
Configure::write('version', '1.3.4');

Configure::write('Select.emptyOptionText', '(choose one...)');
...
Configure::write('Validation.statusOptions', array(
	...
	'active'=>array('label'=>'In Progress', 'color'=>array('fore'=>'#333', 'back'=>'#66ccff', 'border'=>'#00e64d')),			//black/blue/green
...
'CI'=>array('label'=>'CI - Customer Implemented'),
'CA'=>array('label'=>'CA - Compatibility Assumed'),
'CC'=>array('label'=>'CC - Compatibility Confirmed'),
'VS'=>array('label'=>'VS - Validated Solution'),
'PS'=>array('label'=>'PS - ETD Proven Solution')
));