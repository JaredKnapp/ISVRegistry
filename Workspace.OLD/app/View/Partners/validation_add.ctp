...
$this->Html->addCrumb($product['Partner']['name'], array('controller'=>'partners', 'action' => 'edit', $product['Partner']['id'])); 
$this->Html->addCrumb($product['Product']['name'], array('controller'=>'partners', 'action' => 'productEdit', $product['Product']['id']));
$this->Html->addCrumb($title);
?>
<div class="validations form">
<?php echo $this->Form->create('Validation'); ?>
    <fieldset>
        <legend><?php echo __('Add ' . $product['Product']['name'] . ' Validation'); ?></legend>
        <?php

        echo $this->Form->input('version', array('label'=> $product['Product']['name'] . ' Version'));
        ...
        echo $this->Form->input('platformversions_id', array('label'=>'Platform Version', 'id'=>'platformversions'));
        ...
        echo $this->Form->input('estimatedcompletiondate', array('type' => 'text','label' => 'Estimated Completion Date','class' => ' j-date','div' => true));
        echo $this->Form->input('completiondate', array('type' => 'text','label' => 'Actual Completion Date','class' => ' j-date','div' => true));
